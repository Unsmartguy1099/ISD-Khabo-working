                ...
                <div className="item-wrapper">
                    ...
                    <div className="item-content">
                        ...
                        <p className="mbr-text mbr-fonts-style mt-3 display-7">
                            Chicken Provencal is a regional French recipe that can take on many forms. There is no one absolute recipe for Chicken Provencal. <a href="details.html" className="text-primary">Read more..</a></p>
                    </div>
            ...
            <div className="item features-image сol-12 col-md-6 col-lg-3">
                <div className="item-wrapper">
                    ...
                    <div className="item-content">
                        ...
                        <p className="mbr-text mbr-fonts-style mt-3 display-7">
                            Curious as usual, we found some big green tomatoes at the farmers market last weekend and just had to try these fried green tomatoes.&nbsp;<a href="details.html" className="text-primary">Read more..</a></p>
                    </div>
            ...
            <div className="item features-image сol-12 col-md-6 col-lg-3">
                <div className="item-wrapper">
                    ...
                    <div className="item-content">
                        ...
                        <p className="mbr-text mbr-fonts-style mt-3 display-7">
                            To keep the meatballs as moist as possible, I start with a mixture of baking soda and lemon juice.&nbsp;<a href="details.html" className="text-primary">Read more..</a></p>
                    </div>
            ...
            <div className="item features-image сol-12 col-md-6 col-lg-3">
                <div className="item-wrapper">
                    ...
                    <div className="item-content">
                        ...
                        <p className="mbr-text mbr-fonts-style mt-3 display-7">
                            The key to the overall taste is the addition at the end of cotija cheese, a Mexican cheese that is salty and crumbly, much like Greek feta. <a href="details.html" className="text-primary">Read more..</a></p>
                    </div>
                ...
                <div className="item-wrapper">
                    ...
                    <div className="item-content">
                        ...
                        <p className="mbr-text mbr-fonts-style mt-3 display-7">
                            The Smashburger is cooked over high heat with a lot of pressure, which helps the beef develop a deep, rich crust.  <a href="details.html" className="text-primary">Read more..</a></p>
                    </div>
