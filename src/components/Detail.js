...
const Detail = () => {
  ...
  useEffect(() => {
    ...
    return (
      <div >
           <section data-bs-version="5.1" className="menu menu3 cid-tKwAKDXI0l" once="menu" id="menu3-f">
...
<section data-bs-version="5.1" className="features16 cid-tKwMm0KX0k" id="features17-h">
